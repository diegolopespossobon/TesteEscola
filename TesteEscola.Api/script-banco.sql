...
CREATE TABLE dbo.Turma (
    ...
    CONSTRAINT CK_Turma_Vagas CHECK (VagasTotal >= 0 AND VagasDisponiveis >= 0 AND VagasDisponiveis <= VagasTotal)
);
...
CREATE UNIQUE INDEX UX_Matricula_Aluno_Turma ON dbo.Matricula (AlunoId, TurmaId);
GO
